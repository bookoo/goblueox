...
function Blue_Ox_widgets_init() {
	...
	register_sidebar( array(
		...
		'name' => __( 'Blue_Ox : Blog sidebar', 'Blue_Ox' ),
		...
		'description' => __( 'Appears on blog', 'Blue_Ox' ),
		...
		'name' => __( 'Blue_Ox : Interior sidebar', 'Blue_Ox' ),
		...
		'description' => __( 'Appears on interior pages', 'Blue_Ox' ),
...
//* Google Analytics Code - 12.09.2013 *//
...
<script>
  ...
  ga('create', 'UA-45233155-1', 'goblueox.com');
